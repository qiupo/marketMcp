...
class AKToolsService {
    constructor(baseUrl = 'http://127.0.0.1:8080/api/public/') {
        ...
        try {
            ...
            if (!response.data || !Array.isArray(response.data)) {
                return {
                    ...
                    source: stock_js_1.DataSource.AKTOOLS
                };
            }
    ...
    async getSectorData(sector) {
        try {
            ...
            for (const sector of Object.keys(sectorStats)) {
                ...
                const avgChange = stocks.reduce((sum, stock) => sum + parseFloat(stock['changePercent'] || 0), 0) / stocks.length;
...
//# sourceMappingURL=aktools-service.js.map