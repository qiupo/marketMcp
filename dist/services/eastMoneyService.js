...
exports.EastMoneyService = void 0;
...
class EastMoneyService {
    constructor(baseUrl = 'https://push2.eastmoney.com/api/qt/ulist.np/get', timeout = 10000) {
    ...
    async checkService() {
        try {
            const response = await axios_1.default.get(`${this.baseUrl}?fltt=2&fields=f2&secids=1.000001`, {
                headers: {
        ...
        try {
            ...
            if (response.data.rc !== 0 || !response.data?.diff || response.data.diff.length === 0) {
                return {
                    ...
                    data: [],
                    errors: ['未找到股票数据'],
                    source: types_1.DataSource.EASTMONEY
                };
            }
            const stocks = response.data.diff.map((stock) => {
...
//# sourceMappingURL=eastMoneyService.js.map