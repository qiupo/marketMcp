...
import { StockInfo, StockHistoryData, MarketOverview, StockQueryResult, DataSource } from '../types';
...
export class AKToolsService {
  ...
  constructor(baseUrl: string = 'http://127.0.0.1:8080/api/public/', timeout: number = 15000, enabled: boolean = true) {
   ...
   * 格式化成交量
   */
  private formatVolume(volume: number | string): string {
