...
export const FINANCIAL_ANALYSIS_KEY_MAP = {
  ...
  "归属于母公司股东的权益/全部投入资本(%)": "equity_attributable_to_shareholders_of_the_parent_company_division_total_invested_capital",
  ...
  "归属于母公司股东的权益/负债合计": "equity_attributable_to_shareholders_of_the_parent_company_division_total_liabilities",
  "归属于母公司股东的权益/带息债务": "equity_attributable_to_shareholders_of_the_parent_company_division_interest_bearing_debt",
  "有形资产/负债合计": "tangible_assets_division_liabilities",
...
// 投资成本映射
export const STOCK_FUNDED_LIST_KEY_MAP = {
  "募资日期": "fund_date",
  "募资类型": "fund_type",
  "募集资金": "fund_money",
  "增发数量": "additional_issuance_quantity",
...
// 投资成本做市商持股成本
export const STOCK_BROKER_KEY_MAP_ENHANCED = {
...
// 质押信息质押企业详情
export const STOCK_PLEDGE_DATA_KEY_MAP_ENHANCED = {
...
// 质押信息质押贷款记录
export const STOCK_PLEDGE_LOAN_RECORD_KEY_MAP_ENHANCED = {
